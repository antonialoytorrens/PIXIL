...
//
// KDE HTML Widget
// $Id: html.h,v 1.1 2003/09/08 19:42:15 jasonk Exp $
...
public:
	...
	/**
	 * Function used to return the current title
	 */
	QString *getTitle() {return &title;}

	/**
	 * Function to clear the title
	 */
	void ClrTitle() {title = "";}
